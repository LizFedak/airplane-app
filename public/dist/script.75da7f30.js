...
},{"./bundle-url":"../../../../../opt/homebrew/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/@supabase/functions-js/dist/module/helper.js":[function(require,module,exports) {
"use strict";
...
function _main() {
  _main = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var _require, createClient, supabaseUrl, supabaseKey, supabase, getUniqueFlightIds, _getUniqueFlightIds, getCoordinateData, _getCoordinateData, getCoordinateDataForFlight, _getCoordinateDataForFlight, uniqueFlightIds, coordinateData, buildRadioButtons, filterFlightOptionsDOM, map, markers, createMarkers, initMap, addMarkersForFlight, handleRadioChange, _handleRadioChange, radioButtons;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _handleRadioChange = function _handleRadioChange3() {
            _handleRadioChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
              var selectedFlight, coordinateData;
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    selectedFlight = event.target.value.trim(); // Fetch coordinate data for the selected flight
                    _context4.next = 3;
                    return getCoordinateDataForFlight(selectedFlight);
                  case 3:
                    coordinateData = _context4.sent;
                    console.log(coordinateData, 243);
            ...
            return _handleRadioChange.apply(this, arguments);
          };
          handleRadioChange = function _handleRadioChange2(_x2) {
            return _handleRadioChange.apply(this, arguments);
          };
          addMarkersForFlight = function _addMarkersForFlight(flightData) {
            ...
            flightData.forEach(function (flightInfo) {
          ...
          initMap = function _initMap(flights) {
          ...
          createMarkers = function _createMarkers(flightData) {
            for (var i = 0; i < flightData.length; i++) {
              var flightInfo = flightData[i];
              var marker = new google.maps.Marker({
                position: {
                  lat: flightInfo.lat,
                  lng: flightInfo.lon
          ...
          filterFlightOptionsDOM = function _filterFlightOptionsD() {
            var searchQuery = document.getElementById('search').value.toLowerCase();
            uniqueFlightIds.forEach(function (flight) {
              var id = "group-".concat(flight);
              var flightElement = document.getElementById(id);
              var isVisible = flight.toLowerCase().includes(searchQuery);
              flightElement.style.display = isVisible ? 'block' : 'none';
            });
          };
          buildRadioButtons = function _buildRadioButtons(options) {
            ...
            // Create radio buttons and wrap each group in a div
            var radioButtonGroups = options.map(function (option) {
              var radioButton = document.createElement('input');
              radioButton.type = 'radio';
              radioButton.name = 'flightRadio'; // Use the same name for radio buttons to make them exclusive
              radioButton.value = option;
              radioButton.id = option;
              var label = document.createElement('label');
              label.htmlFor = option;
              label.textContent = option;
              var tmpID = "group-".concat(option);
              var radioButtonGroup = document.createElement('div');
              radioButtonGroup.classList.add('radio-button-group', 'visible');
              radioButtonGroup.id = tmpID;
              radioButtonGroup.appendChild(radioButton);
              radioButtonGroup.appendChild(label);
              return radioButtonGroup;
            });

            // Append radio button groups to the container
            radioButtonGroups.forEach(function (radioButtonGroup) {
            ...
            searchBar.addEventListener('input', function () {
              ...
              radioButtonGroups.forEach(function (radioButtonGroup) {
                var optionText = radioButtonGroup.textContent.toLowerCase();
                var isVisible = optionText.includes(searchTerm);
                radioButtonGroup.classList.toggle('visible', isVisible);
              });
            });
          };
          _getCoordinateDataForFlight = function _getCoordinateDataFor2() {
            _getCoordinateDataForFlight = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(flight) {
              var _yield$supabase$from$3, data, error, _coordinateData2;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.prev = 0;
                    _context3.next = 3;
                    return supabase.from('results').select('lat, lon, flight').ilike('flight', "%".concat(flight.trim(), "%"));
                  case 3:
                  ...
                  case 8:
                    ...
                    _coordinateData2 = data.map(function (row) {
                      return {
                        lat: row.lat,
                        lon: row.lon,
                    ...
                    return _context3.abrupt("return", _coordinateData2);
                  case 12:
                    _context3.prev = 12;
            ...
            return _getCoordinateDataForFlight.apply(this, arguments);
          };
          getCoordinateDataForFlight = function _getCoordinateDataFor(_x) {
            return _getCoordinateDataForFlight.apply(this, arguments);
          };
          _getCoordinateData = function _getCoordinateData3() {
            _getCoordinateData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              var _yield$supabase$from$2, data, error, _coordinateData;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.prev = 0;
                    _context2.next = 3;
                    return supabase.from('results').select('lat, lon, flight');
                  case 3:
                  ...
                  case 8:
                    // Map the data to an array of objects
                    _coordinateData = data.map(function (row) {
                      return {
                        lat: row.lat,
                        lon: row.lon,
                        flight: row.flight ? row.flight.trim().toLowerCase() : ""
                    ...
                    return _context2.abrupt("return", _coordinateData);
                  case 12:
                    _context2.prev = 12;
            ...
            return _getCoordinateData.apply(this, arguments);
          };
          getCoordinateData = function _getCoordinateData2() {
            return _getCoordinateData.apply(this, arguments);
          };
          _getUniqueFlightIds = function _getUniqueFlightIds3() {
            _getUniqueFlightIds = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var _yield$supabase$from$, data, error, _uniqueFlightIds;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return supabase.from('unique_flight_id').select('flight');
                  case 3:
                    ...
                    throw new Error("Supabase error: ".concat(error.message));
                  case 8:
                    _uniqueFlightIds = data.map(function (row) {
                      return row.flight.trim().toLowerCase();
                    }).sort();
                    return _context.abrupt("return", _uniqueFlightIds);
                  case 12:
                    _context.prev = 12;
            ...
            return _getUniqueFlightIds.apply(this, arguments);
          };
          getUniqueFlightIds = function _getUniqueFlightIds2() {
            return _getUniqueFlightIds.apply(this, arguments);
          };
          _require = require('@supabase/supabase-js'), createClient = _require.createClient;
          supabaseUrl = 'https://txohdhfxgblngvsgmyjk.supabase.co';
          supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR4b2hkaGZ4Z2Jsbmd2c2dteWprIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDY0ODA1NDgsImV4cCI6MjAyMjA1NjU0OH0.Dbxx8e6ZRrM2RopnkDBe72AKMHlOZ7VD1i5tl4RQnlU';
          supabase = createClient(supabaseUrl, supabaseKey);
          _context5.next = 19;
          return getUniqueFlightIds();
        case 19:
          uniqueFlightIds = _context5.sent;
          _context5.next = 22;
          return getCoordinateData();
        case 22:
          coordinateData = _context5.sent;
          buildRadioButtons(uniqueFlightIds);
          ...
          // console.log(selectedFlight ,183)
          //     // Hide all markers
          //     markers.forEach(marker => {
          //         marker.setMap(null);
          //     });

          //     // Show only markers for the selected flight
          //   console.log(markers, 190)
          //     markers.forEach(marker => {
          //         if (marker.title === selectedFlight) {
          //           console.log(marker, 192)
          //             marker.setMap(map);
          //         }
          //     });
          // }
          ...
          radioButtons = container.querySelectorAll('input[type="radio"]'); // Attach the event listener to each radio button
...
import('https://maps.googleapis.com/maps/api/js?key=AIzaSyDOyoKlcUiUYhBblIw-YR-4UL_n2vniC2w&library=places').then(function () {
  main();
}).catch(function (error) {
  return console.error('Error loading Google Maps API:', error);
});
},{"@supabase/supabase-js":"../node_modules/@supabase/supabase-js/dist/module/index.js"}],"../../../../../opt/homebrew/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("../../../../../opt/homebrew/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../../../../../opt/homebrew/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([["browser.d202933b.js","../node_modules/@supabase/node-fetch/browser.js"]]).then(function(){require("script.js");});
